...
define void @_pocl_kernel_atax_kernel1(float* nocapture readonly %0, float* nocapture readonly %1, float* nocapture %2, i32 %3, i32 %4, { [3 x i64], [3 x i64], [3 x i64], i8*, i32*, i32, i32 }* nocapture readnone %5, i64 %6, i64 %7, i64 %8) local_unnamed_addr #1 !kernel_arg_addr_space !5 !kernel_arg_access_qual !6 !kernel_arg_type !7 !kernel_arg_base_type !8 !kernel_arg_type_qual !9 !kernel_arg_name !10 !pocl_generated !11 {
  %mul.i.i = shl i64 %6, 5
  %cmp217.i = icmp sgt i32 %4, 0, !llvm.access.group !12
  %wide.trip.count.i = zext i32 %4 to i64
  br label %pregion_for_entry.entry.i

pregion_for_entry.entry.i:                        ; preds = %if.end.r_exit.i, %9
  %_local_id_x.0 = phi i64 [ 0, %9 ], [ %16, %if.end.r_exit.i ]
  %add1.i.i = add nuw nsw i64 %_local_id_x.0, %mul.i.i, !llvm.access.group !12
  %conv.i = trunc i64 %add1.i.i to i32, !llvm.access.group !12
  %cmp.i = icmp slt i32 %conv.i, %3, !llvm.access.group !12
  %or.cond.i = and i1 %cmp217.i, %cmp.i, !llvm.access.group !12
  br i1 %or.cond.i, label %for.body.lr.ph.i, label %if.end.r_exit.i, !llvm.access.group !12
...
for.body.lr.ph.i:                                 ; preds = %pregion_for_entry.entry.i
  ...
  %idxprom7.i = ashr exact i64 %sext.i, 32, !llvm.access.group !12
  %arrayidx8.i = getelementptr inbounds float, float* %2, i64 %idxprom7.i, !llvm.access.group !12
  %10 = sext i32 %mul.i to i64, !llvm.access.group !12
  %.pre.i = load float, float* %arrayidx8.i, align 4, !tbaa !14, !llvm.access.group !12
...
for.body.i:                                       ; preds = %for.body.i, %for.body.lr.ph.i
  ...
  %arrayidx5.i = getelementptr inbounds float, float* %1, i64 %indvars.iv.next.i2, !llvm.access.group !12
  %14 = load float, float* %arrayidx5.i, align 4, !tbaa !14, !llvm.access.group !12
  %15 = call float @llvm.fmuladd.f32(float %13, float %14, float %11) #3, !llvm.access.group !12
  store float %15, float* %arrayidx8.i, align 4, !tbaa !14, !llvm.access.group !12
  ...
  br i1 %exitcond.not.i, label %if.end.r_exit.i.loopexit, label %for.body.i, !llvm.loop !18, !llvm.access.group !12

if.end.r_exit.i.loopexit:                         ; preds = %for.body.i
  br label %if.end.r_exit.i

if.end.r_exit.i:                                  ; preds = %if.end.r_exit.i.loopexit, %pregion_for_entry.entry.i
...
atax_kernel1.exit:                                ; preds = %if.end.r_exit.i
  ret void
}
...
define void @_pocl_kernel_atax_kernel1_workgroup(i8** nocapture readonly %0, { [3 x i64], [3 x i64], [3 x i64], i8*, i32*, i32, i32 }* nocapture readnone %1, i64 %2, i64 %3, i64 %4) local_unnamed_addr #2 {
  ...
  %cmp217.i.i = icmp sgt i32 %24, 0, !llvm.access.group !12
...
pregion_for_entry.entry.i.i:                      ; preds = %if.end.r_exit.i.i, %5
  %_local_id_x.i.0 = phi i64 [ 0, %5 ], [ %31, %if.end.r_exit.i.i ]
  ...
  %cmp.i.i = icmp sgt i32 %20, %conv.i.i, !llvm.access.group !12
  %or.cond.i.i = and i1 %cmp217.i.i, %cmp.i.i, !llvm.access.group !12
  br i1 %or.cond.i.i, label %for.body.lr.ph.i.i, label %if.end.r_exit.i.i, !llvm.access.group !12

for.body.lr.ph.i.i:                               ; preds = %pregion_for_entry.entry.i.i
  %mul.i.i = mul nsw i32 %24, %conv.i.i, !llvm.access.group !12
  %sext.i.i = shl i64 %add1.i.i.i, 32, !llvm.access.group !12
  %idxprom7.i.i = ashr exact i64 %sext.i.i, 32, !llvm.access.group !12
  %arrayidx8.i.i = getelementptr inbounds float, float* %16, i64 %idxprom7.i.i, !llvm.access.group !12
  %25 = sext i32 %mul.i.i to i64, !llvm.access.group !12
  %.pre.i.i = load float, float* %arrayidx8.i.i, align 4, !tbaa !14, !llvm.access.group !12
...
for.body.i.i:                                     ; preds = %for.body.i.i, %for.body.lr.ph.i.i
  ...
  %26 = phi float [ %30, %for.body.i.i ], [ %.pre.i.i, %for.body.lr.ph.i.i ]
  %27 = add nsw i64 %indvars.iv.next.i.i2, %25, !llvm.access.group !12
  %arrayidx.i.i = getelementptr inbounds float, float* %8, i64 %27, !llvm.access.group !12
  %28 = load float, float* %arrayidx.i.i, align 4, !tbaa !14, !llvm.access.group !12
  %arrayidx5.i.i = getelementptr inbounds float, float* %12, i64 %indvars.iv.next.i.i2, !llvm.access.group !12
  %29 = load float, float* %arrayidx5.i.i, align 4, !tbaa !14, !llvm.access.group !12
  %30 = call float @llvm.fmuladd.f32(float %28, float %29, float %26) #3, !llvm.access.group !12
  store float %30, float* %arrayidx8.i.i, align 4, !tbaa !14, !llvm.access.group !12
  ...
  br i1 %exitcond.not.i.i, label %if.end.r_exit.i.i.loopexit, label %for.body.i.i, !llvm.loop !18, !llvm.access.group !12

if.end.r_exit.i.i.loopexit:                       ; preds = %for.body.i.i
  br label %if.end.r_exit.i.i

if.end.r_exit.i.i:                                ; preds = %if.end.r_exit.i.i.loopexit, %pregion_for_entry.entry.i.i
  %31 = add nuw nsw i64 %_local_id_x.i.0, 1
...
_pocl_kernel_atax_kernel1.exit:                   ; preds = %if.end.r_exit.i.i
  ret void
}
...
define void @_pocl_kernel_atax_kernel1_workgroup_fast(i8** nocapture readonly %0, { [3 x i64], [3 x i64], [3 x i64], i8*, i32*, i32, i32 }* nocapture readnone %1, i64 %2, i64 %3, i64 %4) local_unnamed_addr #2 {
  ...
  %mul.i.i.i = shl i64 %2, 5
  %cmp217.i.i = icmp sgt i32 %21, 0, !llvm.access.group !12
  %wide.trip.count.i.i = zext i32 %21 to i64
  br label %pregion_for_entry.entry.i.i

pregion_for_entry.entry.i.i:                      ; preds = %if.end.r_exit.i.i, %5
  %_local_id_x.i.0 = phi i64 [ 0, %5 ], [ %28, %if.end.r_exit.i.i ]
  %add1.i.i.i = add nuw nsw i64 %_local_id_x.i.0, %mul.i.i.i, !llvm.access.group !12
  %conv.i.i = trunc i64 %add1.i.i.i to i32, !llvm.access.group !12
  %cmp.i.i = icmp sgt i32 %17, %conv.i.i, !llvm.access.group !12
  %or.cond.i.i = and i1 %cmp217.i.i, %cmp.i.i, !llvm.access.group !12
  br i1 %or.cond.i.i, label %for.body.lr.ph.i.i, label %if.end.r_exit.i.i, !llvm.access.group !12

for.body.lr.ph.i.i:                               ; preds = %pregion_for_entry.entry.i.i
  %mul.i.i = mul nsw i32 %21, %conv.i.i, !llvm.access.group !12
  %sext.i.i = shl i64 %add1.i.i.i, 32, !llvm.access.group !12
  %idxprom7.i.i = ashr exact i64 %sext.i.i, 32, !llvm.access.group !12
  %arrayidx8.i.i = getelementptr inbounds float, float* %13, i64 %idxprom7.i.i, !llvm.access.group !12
  %22 = sext i32 %mul.i.i to i64, !llvm.access.group !12
  %.pre.i.i = load float, float* %arrayidx8.i.i, align 4, !tbaa !14, !llvm.access.group !12
  br label %for.body.i.i, !llvm.access.group !12

for.body.i.i:                                     ; preds = %for.body.i.i, %for.body.lr.ph.i.i
  %indvars.iv.next.i.i2 = phi i64 [ %indvars.iv.next.i.i, %for.body.i.i ], [ 0, %for.body.lr.ph.i.i ]
  %23 = phi float [ %27, %for.body.i.i ], [ %.pre.i.i, %for.body.lr.ph.i.i ]
  %24 = add nsw i64 %indvars.iv.next.i.i2, %22, !llvm.access.group !12
  %arrayidx.i.i = getelementptr inbounds float, float* %7, i64 %24, !llvm.access.group !12
  %25 = load float, float* %arrayidx.i.i, align 4, !tbaa !14, !llvm.access.group !12
  %arrayidx5.i.i = getelementptr inbounds float, float* %10, i64 %indvars.iv.next.i.i2, !llvm.access.group !12
  %26 = load float, float* %arrayidx5.i.i, align 4, !tbaa !14, !llvm.access.group !12
  %27 = call float @llvm.fmuladd.f32(float %25, float %26, float %23) #3, !llvm.access.group !12
  store float %27, float* %arrayidx8.i.i, align 4, !tbaa !14, !llvm.access.group !12
  %indvars.iv.next.i.i = add nuw nsw i64 %indvars.iv.next.i.i2, 1, !llvm.access.group !12
  %exitcond.not.i.i = icmp eq i64 %indvars.iv.next.i.i, %wide.trip.count.i.i, !llvm.access.group !12
  br i1 %exitcond.not.i.i, label %if.end.r_exit.i.i.loopexit, label %for.body.i.i, !llvm.loop !18, !llvm.access.group !12
...
if.end.r_exit.i.i:                                ; preds = %if.end.r_exit.i.i.loopexit, %pregion_for_entry.entry.i.i
  %28 = add nuw nsw i64 %_local_id_x.i.0, 1
